 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)patchPath:(NSString *)path body:(id _Nullable)body queryParameters:(NSDictionary<NSString *, NSString *> *)queryParameters completionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("patch(path:body:queryParameters:completionHandler:)")));
